...
#Create plots.
#Setup 2x2 plotting window.
par(mfcol=c(2,2))
#Top left plot.
plot(epowersubset$datetime, epowersubset$Global_active_power, type="l", xlab="", ylab="Global Active Power")
#Bottom left plot w/legend.
...
#Top right plot.
plot(epowersubset$datetime, epowersubset$Voltage, type="l", xlab="datetime", ylab="Global Active Power")
#Bottom right plot.
plot(epowersubset$datetime, epowersubset$Global_reactive_power, type="l", xlab="datetime", ylab="Global Active Power")
dev.off()